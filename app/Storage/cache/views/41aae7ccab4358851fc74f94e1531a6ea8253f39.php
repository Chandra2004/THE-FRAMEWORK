...
<body class="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen">
    ...
    <main class="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <?php if(!empty($notification)): ?>
            <div class="alert mb-8 p-4 rounded-lg border border-<?php echo e($notification['status'] == 'success' ? 'cyan-500/30' : 'red-500/30'); ?> bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm relative overflow-hidden transition-all duration-300 auto-dismiss">
                <!-- Gradient accent bar -->
                <div class="absolute left-0 top-0 h-full w-1.5 bg-gradient-to-b from-<?php echo e($notification['status'] == 'success' ? 'cyan-500' : 'red-500'); ?> to-<?php echo e($notification['status'] == 'success' ? 'blue-600' : 'pink-600'); ?>"></div>
                ...
                <div class="flex items-start gap-3 pl-4">
                    ...
                    <!-- Content -->
                    <div class="flex-1">
                        <h3 class="text-sm font-semibold text-<?php echo e($notification['status'] == 'success' ? 'cyan-400' : 'red-400'); ?> mb-1">
                            <?php echo e(ucfirst($notification['status'])); ?>

                        </h3>
                        <p class="text-sm text-gray-300 leading-tight">
                            <?php echo e($notification['message'] ?? 'An error occurred.'); ?>
...
</html><?php /**PATH D:\NGODING\PHP\STANDARD THE-FRAMEWORK\resources\Views/interface/user.blade.php ENDPATH**/ ?>